...
class TimetablesControllerTest < ActionController::TestCase
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post :create, timetable: { academic_year: @timetable.academic_year, end_at: @timetable.end_at, level: @timetable.level, references: @timetable.references, start_at: @timetable.start_at, term: @timetable.term }
    end
  ...
  test "should update timetable" do
    patch :update, id: @timetable, timetable: { academic_year: @timetable.academic_year, end_at: @timetable.end_at, level: @timetable.level, references: @timetable.references, start_at: @timetable.start_at, term: @timetable.term }
    assert_redirected_to timetable_path(assigns(:timetable))
  end
